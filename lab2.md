...
2. Navigate to http://localhost:5001 in a browser to see the results. If you are using play-with-docker, click the link `5001` that should appear near the top of your session. If all else fails: `curl localhost:5001` works...
